...
int main() {
    ...
    // goBilda servos have a range of 300 degrees with
    // corresponding to pulses of 500 and 2500 microseconds
    go_bilda.apply_two_pairs(500, 2500, -150, 150);

    // Create a servo on pin 0 using the custom calibration
